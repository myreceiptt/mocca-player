...
function loadMusic(indexNumb){
  ...
  musicImg.src = `images/${allMusic[indexNumb - 1].src}.webm`;
  mainAudio.src = `https://ipfs.io/ipfs/QmSBhFJ1K4wXnQx3cWwrv8Xu7motb9DQeY6P4rrKmLF6Y6/${allMusic[indexNumb - 1].src}.mp3`;
}
...
const repeatBtn = wrapper.querySelector("#looping");
repeatBtn.addEventListener("click", ()=>{
  ...
  switch(getText){
    ...
    //   repeatBtn.setAttribute("title", "Setlist Shuffled");
    //   break;
    // case "shuffle":
    //   repeatBtn.innerText = "repeat";
    //   repeatBtn.setAttribute("title", "Setlist Looped");
    //   break;
    case "shuffle":
      repeatBtn.innerText = "repeat_one";
      repeatBtn.setAttribute("title", "Song Looped");
    ...
    case "repeat_one":
      repeatBtn.innerText = "shuffle";
      repeatBtn.setAttribute("title", "Song Not Looped");
      break;
  }
});
...
for (let i = 0; i < allMusic.length; i++) {
  let liTag = `<li li-index="${i + 1}">
                ...
                <audio class="${allMusic[i].src}" src="https://ipfs.io/ipfs/QmSBhFJ1K4wXnQx3cWwrv8Xu7motb9DQeY6P4rrKmLF6Y6/${allMusic[i].src}.mp3"></audio>
              </li>`;
